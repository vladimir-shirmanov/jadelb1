package com.company.logic.propositional.parsing.ast;
...
public class ComplexSentence extends Sentence {
    ...
    public boolean equals(Object o) {
        ...
        if (other.hashCode() == this.hashCode()) {
            if (other.getConnective().equals(this.getConnective()) && other.getNumberSimplerSentences() == this.getNumberSimplerSentences()) {
    ...
    public String toString() {
        if (cachedConcreteSyntax == null) {
            if (isUnarySentence()) {
                ...
                cachedConcreteSyntax = bracketSentenceIfNecessary(getConnective(), getSimplerSentence(0)) + " " + getConnective() + " " + bracketSentenceIfNecessary(getConnective(), getSimplerSentence(1));
            }
        }
